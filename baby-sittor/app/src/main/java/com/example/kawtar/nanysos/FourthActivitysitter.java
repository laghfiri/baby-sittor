...
public class FourthActivitysitter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourth_sitter);
    ...
    public void updateprofil(View v){
        Intent i = new Intent(getApplicationContext(), Updateprofilsitter.class);
        i.putExtra("key",id);
        startActivity(i);
    }
}